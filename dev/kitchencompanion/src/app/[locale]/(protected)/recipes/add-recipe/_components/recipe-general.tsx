      ...
      <form className="grid w-full items-start gap-6">
        <fieldset className="grid gap-6 rounded-lg border p-4">
          ...
          <div className="grid gap-3">
            ...
            <Input id="name" type="text" placeholder="Sauce tomate" />
          </div>
          <div className="grid gap-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="grid gap-3">
              ...
              <div className="flex gap-2">
                <Input id="cookTime" type="number" placeholder="60" />
                <Select name="prepTimeUnit">
                  <SelectTrigger>
                    <SelectValue placeholder="Unité" />
                  </SelectTrigger>
        ...
        <fieldset className="grid gap-6 rounded-lg border p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-3">
              <Input id="yield" type="number" placeholder="Quantité" />
            </div>
            <div className="grid gap-3">
              <Select name="unit">
        ...
        <fieldset className="grid gap-6 rounded-lg border p-4">
          ...
          <div className="grid gap-3">
            ...
            <Input id="name" type="text" defaultValue={"v.1.0.0"} />
          </div>
        </fieldset>
      </form>
    </div>
